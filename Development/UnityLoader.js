...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'space cup program v2.data';
    var REMOTE_PACKAGE_BASE = 'space cup program v2.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 8235559;
      var PACKAGE_UUID = 'b679248a-072c-478d-8475-7cd86ace3eb4';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 4907918, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(4907918, 4907939, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(4907939, 4911002, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(4911002, 6711874, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(6711874, 8207934, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(8207934, 8235559, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_space cup program v2.data');

    };
    Module['addRunDependency']('datafile_space cup program v2.data');
